...
const BlogCard = ({ data }) => {
    ...
    return (
        <div className="relative rounded-[8px] overflow-hidden bg-secondary-grey w-full h-full">
            ...
            <div className="w-full py-8 px-2 md:px-4">
                <h3 className="px-2 md:px-0 font-arsenal text-base lg:text-[20px] text-primary-black leading-[125%] uppercase mb-4 line-clamp-3">
                    {data.title[locale]}
                </h3>
                <p className="px-2 md:px-0 font-montserrat text-[12px] lg:text-[14px] leading-[125%] text-secondary-greyText mb-8 line-clamp-4">
