...
const BlogListSection = ({ blogs }) => {
    ...
    const handlePrevClick = () => {
        setCurrentPage(prev =>
            prev > 0
                ? prev - 1
                : Math.ceil((blogs?.length || 0) / itemsPerPage) - 1
        );
        scrollToTop();
    };
    ...
    const handleNextClick = () => {
        setCurrentPage(prev =>
            prev < Math.ceil((blogs?.length || 0) / itemsPerPage) - 1
                ? prev + 1
                : 0
        );
        scrollToTop();
    ...
    return (
        <div
            ref={blogRef}
            className="relative pt-[115px] pb-[100px] lg:pt-[86px]"
        >
            <Image
                src={leavesTopMob}
                alt="leaves image"
            ...
            <Image
                ...
                width={243}
                height={243}
                className="absolute hidden lg:block w-auto h-[243px] bottom-[-69px] scale-120% -z-10"
            />
