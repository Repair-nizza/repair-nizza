...
const ServiceDetails = ({ service }) => {
    ...
    const getPros = () => {
        return service.pros?.[locale] || service.pros?.en || service.pros?.ru;
    };

    const getAdditionalInfo = () => {
        return (
            service.additionalInfo?.[locale] ||
            service.additionalInfo?.en ||
            service.additionalInfo?.ru
        );
    };
    ...
    const imageUrl =
        gallery.length > 0
            ? gallery[gallery.length - 1]?.image?.asset?.url
            : null;
    ...
    if (!description && !process && !pros && !additionalInfo) {
        return null;
    }
    ...
    return (
        <>
            ...
            <div className="lg:hidden">
                <ServiceGallery
                    service={{ ...service, gallery: galleryImages }}
                />
            </div>
            ...
            {(process || pros || additionalInfo || imageUrl) && (
                <div
                    ref={detailsRef}
                    className="mb-[50px] lg:mb-[51px] relative"
                >
                                    ...
                                    {process && (
                                        <div className="mb-6">
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    maxHeight: openCards.process
                                                        ? "1000px"
                                                        : "0",
                                                    opacity: openCards.process
                                                        ? 1
                                                        : 0,
                                                }}
                                            >
                                                <BlockContentRenderer
                                                    content={process}
                                                    className="font-montserrat font-light text-xs text-primary-black"
                                                />
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {pros && (
                                        <div className="mb-6">
                                            ...
                                            <div
                                                className="overflow-hidden transition-all duration-300 ease-in-out"
                                                style={{
                                                    maxHeight: openCards.pros
                                                        ? "1000px"
                                                        : "0",
                                                    opacity: openCards.pros
                                                        ? 1
                                                        : 0,
                                                }}
                                            >
                                ...
                                {process && (
                                    <div className="mb-7 lg:mb-0 lg:flex lg:flex-col">
                                        ...
                                        >
                                            <BlockContentRenderer
                                                content={process}
                                                className="font-montserrat font-light text-xs text-primary-black w-full md:w-full lg:w-[530px] lg:text-sm"
                                            />
                                        </div>
                                    </div>
                                )}
