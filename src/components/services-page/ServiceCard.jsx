...
const ServiceCard = ({ service, index }) => {
    ...
    const imageUrl = service.gallery?.image?.asset?.url;
                    ...
                    <>
                        ...
                        {imageUrl ? (
                            <motion.div
                                ...
                                className="relative w-[845px] h-[500px] -mr-10 overflow-hidden rounded-[20px] md:w-[50%] lg:w-[845px]"
                            >
                                <Image
                                    src={imageUrl}
                                    alt={title}
                    ...
                    <>
                        {imageUrl ? (
                            <motion.div
                                ...
                                className="relative w-[845px] h-[500px] -ml-10 overflow-hidden rounded-[20px] md:w-[50%] lg:w-[845px]"
                            >
                                <Image
                                    src={imageUrl}
                                    alt={title}
