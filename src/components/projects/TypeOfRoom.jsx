...
const TypeOfRoom = ({ data }) => {
    ...
    const isMobImgInView = useInView(mobImgRef, {
        once: true,
        margin: "-100px",
    });
    // Планшетные рефы
    ...
    const isTabImgInView = useInView(tabImgRef, {
        once: true,
        margin: "-100px",
    });
    // Десктопные рефы
                ...
                <div className="flex flex-col gap-6">
                    <div className="mb-[100px] md:mb-0">
                        <motion.h2
                            ...
                            animate={
                                isMobTitleInView ? { y: 0, opacity: 1 } : {}
                            }
                    ...
                    <div className="relative w-[310px] h-[172px] mx-auto">
                        <Image
                            src={treeMob}
                            alt="motif"
                            className="absolute top-[-107px] left-[-48px] md:hidden rotate-[-105.33deg]"
                            width={158}
                            height={158}
                        />
