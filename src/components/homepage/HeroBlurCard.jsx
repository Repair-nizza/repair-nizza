...
const HeroBlurCard = ({ data }) => {
    ...
    return (
        <div className="absolute bottom-0 left-6 lg:left-10 overflow-hidden">
            <motion.div
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                transition={{
            ...
            >
                <div>
                    ...
                    <h3 className="font-arsenal font-normal text-base text-primary-white uppercase mb-4 w-[171px] lg:w-[246px] lg:text-xl lg:leading-6 line-clamp-2">
                        {data.title[locale]}
                    </h3>
                    <p className="font-montserrat font-light text-xs text-primary-white mb-6 lg:text-sm line-clamp-3">
