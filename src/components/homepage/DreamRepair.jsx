        ...
        <Container className="relative">
            ...
            <div className="pt-[94px] pb-[137px] lg:flex lg:justify-between lg:flex-row-reverse lg:pt-[213px] lg:pb-[186px]">
                    ...
                    <div className="lg:flex lg:justify-between lg:items-end lg:mb-9">
                        ...
                        >
                            <button
                                ...
                                className="w-[317px] h-[52px] rounded-[32px] bg-primary-black text-primary-white font-montserrat font-normal text-sm leading-5 hover:bg-primary-white hover:text-primary-black hover:border-primary-black border transition-all duration-300 will-change-opacity"
                            >
                ...
                <motion.div
                    ...
                    initial={{ opacity: 0 }}
                    animate={
                        isMobileButtonInView ? { opacity: 1 } : { opacity: 0 }
                    }
                    transition={{
                        duration: 0.6,
                        ease: "easeInOut",
                ...
                >
                    <button
                        onClick={handleConsultationClick}
                        className="w-[310px] h-[52px] rounded-[32px] bg-primary-black text-primary-white font-montserrat font-normal text-sm leading-5 mx-auto md:flex md:justify-center md:items-center hover:bg-primary-white hover:text-primary-black hover:border-primary-black border transition-all duration-300 will-change-opacity"
                    >
                        {t("dreamRepair.button")}
                    </button>
                </motion.div>
